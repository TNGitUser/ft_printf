...
#    Updated: 2019/05/07 10:14:39 by lucmarti         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_PATH = ./src
SRC_FILE = ft_printf.c error.c init.c parser.c bool.c peacemaker.c\
		   hex.c print.c get_csp.c get_iuo.c get_xf.c print_int.c print_hf.c\
		   print_ptr.c
...
$(NAME): $(OBJ)
	...
	@ar -rc $(NAME) $(OBJ) libft/objs/*.o libft/libft.h src/ft_printf.h
	@ranlib $(NAME)
